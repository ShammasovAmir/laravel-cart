                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <select name="quantity" id="quantity" value="{{ $value['quantity'] }}" onchange="onQuantityUpdate()">
                                            @for ($i = 1; $i <= 10; $i++) 
                                                <option value="{{ $i }}" id="{{ $key }}" 
...
<script>
    function onQuantityUpdate() {
        ...
        var selectedId = quantity.options[quantity.selectedIndex].id;
        window.location.href = '/update-cart-item-quantity/' + selectedId + '/' + selectedValue;
    }
</script>
@endsection